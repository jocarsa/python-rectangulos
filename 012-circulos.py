...
for i in range(300):  # Iterate 300 times to create 300 images
    try:
        ...
        # Calculate circle size and distance based on image dimensions
        max_circle_size = image_width // (circle_columns + 1)
        distance = (image_width - (circle_columns * max_circle_size)) // (circle_columns - 1)
